...
exports.register = (server, options) => {
  ...
  shimWreck(wreck.__proto__, 'get', httpId);
  shimWreck(wreck.__proto__, 'delete', httpId);
  shimWreck(wreck.__proto__, 'patch', httpId);
  shimWreck(wreck.__proto__, 'post', httpId);
  shimWreck(wreck.__proto__, 'put', httpId);
  shimWreck(wreck.__proto__, 'request', httpId);
  shimWreck(wreck.__proto__, 'read', httpId);
